...
?>
    <div class="container">
        ...
        <div class="middlepane">
            ...
            <div>Access point is <span id="ap-status">
                    <?php isProcessRunning("hostapd")  ?>
                </span><button onclick="toggle_ap()" type="button">Toggle!</button>
                <form action="./scripts/apply_ap.php" method="post">
                    ...
                    <input id="ap_name" placeholder="Network_Name" maxlength="32" minlength="1" size="15" name="ap_name"
                        type="text" required>
                    <br>
                    <label for="country_code">Country code: </label>
                    <input id="country_code" placeholder="US" maxlength="2" minlength="1" size="2" name="country_code"
                        type="text" required>
                    <br>
                    ...
                    <input id="password" maxlength="63" minlength="8" size="15" name="password" type="password"
                        required>
                    <br>
